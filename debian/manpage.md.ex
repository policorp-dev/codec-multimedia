% codec-multimedia(SECTION) | User Commands
%
% "November 12 2025"
...
codec-multimedia - program to do something

# SYNOPSIS

**codec-multimedia** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**codec-multimedia** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **codec-multimedia** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**codec-multimedia** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    codec-multimedia. See **foo.conf**(5) for further details.
...
**codec-multimedia** provides some return codes, that can be used in scripts:
