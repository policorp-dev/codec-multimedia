...
class CodecMultimediaApplication(Adw.Application):
    """The main application singleton class."""

    def __init__(self):
        super().__init__(application_id='org.gnome.CodecMultimedia',
                         flags=Gio.ApplicationFlags.DEFAULT_FLAGS,
                         resource_base_path='/org/gnome/CodecMultimedia')
    ...
    def do_activate(self):
        ...
        if not win:
            win = CodecMultimediaWindow(application=self)
        win.present()
    ...
    def on_about_action(self, *args):
        ...
        about = Adw.AboutDialog(application_name='Multimedia Codecs Installer',
                                ...
                                developer_name='Policorp Tecnologia',
                                version=VERSION,
