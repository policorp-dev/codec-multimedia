...
function smoothPageFade(target_url, options = {}) {
    let queryParams = new URLSearchParams(options).toString();
    if (!queryParams) queryParams = "";

    const finalUrl = `${target_url}?${queryParams}`;
...
// For pages that depend on an internet connection, but store couldn't connect.
